...
import static com.xunhao.project.constant.UserConstant.USER_LOGIN_STATE;
...
import com.xunhao.project.model.enums.UserRoleEnum;
import com.xunhao.project.model.vo.LoginUserVO;
import com.xunhao.project.model.vo.UserVO;
import com.xunhao.project.utils.SqlUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "xunhao";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String userName) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtil.md5Hex(SALT + userPassword + RandomUtil.randomNumbers(8));
            // 4. 插入数据
            User user = new User();
